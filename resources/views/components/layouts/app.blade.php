    ...
    <div class="shell">
        <aside class="sidebar">
            ...
            <nav class="sidebar__nav">
                <div class="sidebar__section">Utama</div>
                ...
                <div class="sidebar__section">Manajemen Aset</div>
                ...
                <div class="sidebar__section">Referensi</div>
                ...
                <a href="{{ route('announcements.index') }}" class="{{ request()->routeIs('announcements.*') ? 'is-active' : '' }}">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M18 8a6 6 0 0 0-12 0c0 7-3 9-3 9h18s-3-2-3-9" stroke-linecap="round" stroke-linejoin="round"/><path d="M13.73 21a2 2 0 0 1-3.46 0" stroke-linecap="round"/></svg>
                    Pengumuman
                </a>

                @if (auth()->user()->isAdmin())
                    <div class="sidebar__section">Administrasi</div>
